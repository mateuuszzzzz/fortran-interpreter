module Interpreter where
    ...
    -- Helper function to get function from StateMonad
    ...
    -- Helper function to get position of variable associated with the name
    ...
    -- Traverse stack to the given Location
    fetch :: Location -> Stack -> Int
    fetch n (v:vs)   =  if n == 1 then v else fetch (n-1) vs


    -- Put new element to a place of already existing one 
